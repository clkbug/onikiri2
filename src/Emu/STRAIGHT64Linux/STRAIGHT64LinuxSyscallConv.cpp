...
#include "Emu/STRAIGHT64Linux/STRAIGHT64LinuxSyscallID.h"
...
int STRAIGHT64LinuxSyscallConv::Get_MAP_ANONYMOUS()
{
    return PPC64_MAP_ANONYMOUS;
}

int STRAIGHT64LinuxSyscallConv::Get_MREMAP_MAYMOVE()
{
    return PPC64_MREMAP_MAYMOVE;
}

int STRAIGHT64LinuxSyscallConv::Get_CLK_TCK()
{
    return PPC64_CLK_TCK;
}

u32 STRAIGHT64LinuxSyscallConv::OpenFlagTargetToHost(u32 flag)
{
...
void STRAIGHT64LinuxSyscallConv::syscall_fstat32(EmulatorUtility::OpEmulationState* opState)
{
    HostStat st;
...
void STRAIGHT64LinuxSyscallConv::syscall_stat32(OpEmulationState* opState)
{
    HostStat st;
...
void STRAIGHT64LinuxSyscallConv::write_stat32(u64 dest, const HostStat &src)
{
