...
STRAIGHT64Converter::OpDef STRAIGHT64Converter::m_OpDefsBase[] =
{
    ...
    {"BLT",     MASK_STB,    0b000011,      1,   { OpClassCode::iBC,     {-1, -1},   {R1, R2, I0},   RISCV64BranchRelCond<LShiftL<u64, S2, IntConst<u64, 2>, 0x3f >, Compare<S0, S1, IntCondLessSigned<u64> > >}},
    {"BGE",     MASK_STB,    0b100011,      1,   { OpClassCode::iBC,     {-1, -1},   {R1, R2, I0},   RISCV64BranchRelCond<LShiftL<u64, S2, IntConst<u64, 2>, 0x3f >, Compare<S0, S1, IntCondGreaterEqualSigned<u64> > >}},
    {"BLTu",    MASK_STB,    0b010011,      1,   { OpClassCode::iBC,     {-1, -1},   {R1, R2, I0},   RISCV64BranchRelCond<LShiftL<u64, S2, IntConst<u64, 2>, 0x3f >, Compare<S0, S1, IntCondLessUnsigned<u64> > >}},
    {"BGEu",    MASK_STB,    0b110011,      1,   { OpClassCode::iBC,     {-1, -1},   {R1, R2, I0},   RISCV64BranchRelCond<LShiftL<u64, S2, IntConst<u64, 2>, 0x3f >, Compare<S0, S1, IntCondGreaterEqualUnsigned<u64> > >}},
    {"BEQ",     MASK_STB,    0b001011,      1,   { OpClassCode::iBC,     {-1, -1},   {R1, R2, I0},   RISCV64BranchRelCond<LShiftL<u64, S2, IntConst<u64, 2>, 0x3f >, Compare<S0, S1, IntCondEqual<u64> > >}},
    ...
    // No Reg
    {"J",       MASK_NOREG, OPCODE_NOREG(0b00'0), 1,  { { OpClassCode::iJUMP,     {-1, -1},   {I0, -1, -1},   RISCV64BranchRelUncond<LShiftL<u64, S0, IntConst<u64, 2>, 0x3f > > } } },
    {"JAL",     MASK_NOREG, OPCODE_NOREG(0b01'0), 1,  { { OpClassCode::CALL_JUMP, {R0, -1},   {I0, -1, -1},   RISCV64CallRelUncond<D0, LShiftL<u64, S0, IntConst<u64, 2>, 0x3f > > } } },
