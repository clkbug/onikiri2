...
STRAIGHT64Converter::OpDef STRAIGHT64Converter::m_OpDefsBase[] =
{
    ...
    {"OR.32",    MASK_TWOREG, OPCODE_TWOREG32(0b00000, 0b110), 1, { OpClassCode::iALU, {R0, -1}, {R1, R2, -1}, SetSext<D0, BitAnd<u32, S0, S1> >}},
    {"AND.32",   MASK_TWOREG, OPCODE_TWOREG32(0b00000, 0b111), 1, { OpClassCode::iALU, {R0, -1}, {R1, R2, -1}, SetSext<D0, BitOr<u32, S0, S1> >}},
