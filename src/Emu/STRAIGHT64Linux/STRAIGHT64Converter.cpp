...
STRAIGHT64Converter::OpDef STRAIGHT64Converter::m_OpDefsBase[] =
{
    ...
    { "FTOI",   MASK_OPCODE, OPCODE(27),    1,{ { OpClassCode::ifCONV,{ R0,-1 },{ R1,-1, -1 }, Set<D0, Cast<RegisterType, Cast<s64, Cast<s32, AsFP<f32, Cast<s32, S0> > > > > >} } },
    { "ITOF",   MASK_OPCODE, OPCODE(28),    1,{ { OpClassCode::ifCONV,{ R0,-1 },{ R1,-1, -1 }, Set<D0, Cast<RegisterType, Cast<s64, AsInt<s32, Cast<f32, S0> > > > > } } },
    ...
    { "FSLT",   MASK_OPCODE, OPCODE(33),    1,{ { OpClassCode::fADD,{ R0,-1 },{ R1,R2,-1 },Set<D0, STRAIGHT64FCompare<f32, AsFP<f32, Cast<u32, S0> >, AsFP<f32, Cast<u32, S1> >  > > } } },
